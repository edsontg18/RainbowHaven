...
import 'thenormal_model.dart';
export 'thenormal_model.dart';

class ThenormalWidget extends StatefulWidget {
  const ThenormalWidget({super.key});

  @override
  State<ThenormalWidget> createState() => _ThenormalWidgetState();
}

class _ThenormalWidgetState extends State<ThenormalWidget> {
  late ThenormalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ThenormalModel());
  }
            ...
            children: [
              Stack(
                children: [
                  ...
                  Align(
                    alignment: AlignmentDirectional(-0.08, -0.24),
                    child: Text(
                      'Alejandro de Humboldt 1100,\n Mirador, 64070  Monterrey, N.L.',
