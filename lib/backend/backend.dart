...
import 'schema/sugerencias_record.dart';
...
export 'schema/sugerencias_record.dart';
...
/// Functions to query SugerenciasRecords (as a Stream and as a Future).
Future<int> querySugerenciasRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SugerenciasRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SugerenciasRecord>> querySugerenciasRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SugerenciasRecord.collection,
      SugerenciasRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SugerenciasRecord>> querySugerenciasRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
