...
import 'cosmo_model.dart';
export 'cosmo_model.dart';

class CosmoWidget extends StatefulWidget {
  const CosmoWidget({super.key});

  @override
  State<CosmoWidget> createState() => _CosmoWidgetState();
}

class _CosmoWidgetState extends State<CosmoWidget> {
  late CosmoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CosmoModel());
  }
